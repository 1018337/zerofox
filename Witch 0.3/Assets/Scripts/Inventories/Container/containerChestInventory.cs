...
public class ContainerChestInventory : container
{
    private GameObject containerPrefab;
    int x = 0;
    int slotSize = 80;

    public ContainerChestInventory(inventory containerInventory, inventory playerInventory, int limitSize, int limitHeight) : base(containerInventory, playerInventory)
    {
